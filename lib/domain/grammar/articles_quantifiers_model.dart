class ArticlesQuantifiersModel {
  ArticlesQuantifiersModel({
    required this.task,
  ...
  factory ArticlesQuantifiersModel.fromJson(Map<String, dynamic> json) {
    return ArticlesQuantifiersModel(
      task: json["task"],
