...
class IdiomPhrasesWidget extends StatefulWidget {
  const IdiomPhrasesWidget({
    super.key,
    required this.state,
  });
  final VocabularyIdiomPhrasesState state;

  @override
  _IdiomPhrasesWidgetState createState() => _IdiomPhrasesWidgetState();
}

class _IdiomPhrasesWidgetState extends State<IdiomPhrasesWidget> {
  ...
  void initState() {
    ...
    _showAnswers = List.filled(
        widget.state.idiomPhrasesModel.first.questions.length, false);
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.state.idiomPhrasesModel.first.description ??
            ...
            ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: widget.state.idiomPhrasesModel.first.questions.length,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(widget.state.idiomPhrasesModel.first
                        ...
                        if (_showAnswers[index])
                          Text(
                            "Answer: ${widget.state.idiomPhrasesModel.first.answers[index] ?? "Answer text"}",
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.green,
                            ),
