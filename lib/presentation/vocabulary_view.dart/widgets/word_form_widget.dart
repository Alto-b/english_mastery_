...
class WordFormView extends StatefulWidget {
  ...
  final VocabularyWordFormsState state;

  @override
  _WordFormViewState createState() => _WordFormViewState();
}
...
class _WordFormViewState extends State<WordFormView> {
  ...
  void initState() {
    super.initState();
    _showAnswers =
        List.filled(widget.state.wordFormsModel.first.questions.length, false);
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.state.wordFormsModel.first.description ??
            ...
            ListView.builder(
              ...
              shrinkWrap: true,
              itemCount: widget.state.wordFormsModel.first.questions.length,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          widget.state.wordFormsModel.first.questions[index] ??
                              "Question text",
                          style: const TextStyle(
                            fontSize: 16,
                        ...
                        if (_showAnswers[index])
                          Text(
                            "Answer: ${widget.state.wordFormsModel.first.answers[index] ?? "Answer text"}",
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.green,
                            ),
